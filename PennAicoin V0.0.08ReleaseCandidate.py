...
class SettingsDialog(QDialog):
    def __init__(self, parent=None):
        ...
        """)
        menu_items = ["主题", "消息通知", "通用设置", "用户协议", "文件管理", "文件加密", "快捷键", "关于"]
    ...
    def create_pages(self):
        ...
        self.add_menu_page("消息通知", self.create_notification_settings_page())
    ...
    def create_notification_settings_page(self):
        ...
        # 消息通知设置内容
        notification_label = QLabel("消息通知设置内容")
    ...
    def create_about_page(self):
        ...
        icon_label = QLabel()
        pixmap = QPixmap('resources/robot_icon.png')  # 替换为您的图标路径
        ...
        self.load_text_file(os.path.join(os.getcwd(), "license", "MIT_License_ZH-CN.txt"), self.mit_license_zh_cn_label)
        ...
        self.load_text_file(os.path.join(os.getcwd(), "license", "MIT_License_ZH-TW.txt"), self.mit_license_zh_tw_label)
        ...
        self.load_text_file(os.path.join(os.getcwd(), "license", "MIT_License_EN.txt"), self.mit_license_en_label)
        ...
        self.load_text_file(os.path.join(os.getcwd(), "license", "LEGAL.md.txt"), self.legal_md_label)
    ...
    def load_user_agreement(self):
        ...
        try:
            file_path = os.path.join(os.getcwd(), "license", "user_agreement.txt")
            with open(file_path, 'r', encoding='utf-8') as file:
                content = file.read()
            ...
            if file_dialog.exec_():
                ...
                if ok and password:
                    if self.file_manager.import_from_jzrj(file_path, password):
                        ...
                        # 刷新记录
                        if hasattr(self.parent_app, 'load_records'):
...
class LoginDialog(QDialog):
    ...
    def login(self):
        ...
        users = [
            ...
            {"username": "user1", "password": "user123", "permission": "User"},
            {"username": "guest", "password": "guest123", "permission": "Guest"}
        ]
...
class AccountingApp(QMainWindow):
    ...
    def init_ui(self):
        ...
        user_avatar_label.setPixmap(QPixmap('resources/user_icon.png').scaled(40, 40, Qt.IgnoreAspectRatio))
        ...
        self.add_button.setIcon(QIcon('resources/Add_icon.png'))
        ...
        self.delete_button.setIcon(QIcon('resources/delete_icon.png'))
        ...
        self.modify_button.setIcon(QIcon('resources/Write_icon.png'))
        ...
        self.export_button.setIcon(QIcon('resources/Export_icon.png'))
        ...
        self.import_button.setIcon(QIcon('resources/Import_icon.png'))
        ...
        self.settings_button.setIcon(QIcon('resources/settings_icon.png'))
        ...
        self.about_button.setIcon(QIcon('resources/about_icon.png'))
        ...
        self.switch_user_button.clicked.connect(self.show_login_dialog)
        ...
        robot_label = QLabel()
        robot_label.setPixmap(QPixmap('resources/robot_icon.png').scaled(200, 125, Qt.IgnoreAspectRatio))
    ...
    def start_recording(self):
        try:
            ...
            model_path = "resources/vosk-model-small-cn-0.22"
            timeout = 20
    ...
    def show_login_dialog(self):
        ...
        if login_dialog.exec_() == QDialog.Accepted:
            # 这里应从登录对话框中获取当前用户信息
            # 仅为示例，实际应用中应从登录对话框传递用户信息
            self.current_user = "admin"  # 假设登录成功后的用户名
            self.user_label.setText(f"当前用户: {self.current_user}")
            self.update_bottom_info()

    def authenticate_user(self):
        """验证用户密码"""
        password, ok = QInputDialog.getText(self, "密码验证", "请输入程序密码:", QLineEdit.Password)
        if ok:
            # 这里应使用安全的密码验证逻辑
            # 仅为示例，实际应使用哈希验证
            if password == "正确密码":
                ...
                QMessageBox.warning(self, "密码验证", "密码错误！")
                return False
        return False
